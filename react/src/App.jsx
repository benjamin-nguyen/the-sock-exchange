      ...
      <main role="main" className="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <h2>Featured</h2>
            <div className="promo-card-container d-flex flex-row justify-content-start" style={{ gap: "20px", padding: "20px" }}>
              {
            ...
            <div className="sock-card-container" style={{ display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
            {
                data.map((sock) => (
